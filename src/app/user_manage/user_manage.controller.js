...
module.controller('UserEditDialogController', [
    '$scope', '$rootScope', '$uibModalInstance', '$timeout', 'UserManageService', 'Alert','$cookies', 'user',
    function ($scope, $rootScope, $modalInstance, $timeout, userManageService, $alert,$cookies, user) {
